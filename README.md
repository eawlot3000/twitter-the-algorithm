# the VERY INITIAL VERSION of twitter the algorithm repo released by twitter on github clone from [the-algorithm](https://github.com/twitter/the-algorithm)
# hashtag open source twitter :]
